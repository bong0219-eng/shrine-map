...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V3-S-GP1';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V3-S-GP1';
...
const _PRAYER_ASSET_VERSION='V3-S-GP1';
...
const _RETREAT_ASSET_VERSION='V3-S-GP1';
...
const _SHRINE_ASSET_VERSION='V3-S-GP1';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
