...
const APP_SHELL = [
  ...
  './manifest.json?v=V3',
  './diocese.html?v=V3',
  './qa-firebase.html?v=V3',
  './prayer.js?v=V3',
  './retreats.js?v=V3',
  './shrines.js?v=V3',
  './parishes-seoul.js?v=V3',
  './parishes-incheon.js?v=V3',
  './parishes-suwon.js?v=V3',
  './parishes-uijeongbu.js?v=V3',
  './parishes-chuncheon.js?v=V3',
  './parishes-wonju.js?v=V3',
  './parishes-daejeon.js?v=V3',
  './parishes-cheongju.js?v=V3',
  './parishes-daegu.js?v=V3',
  './parishes-busan.js?v=V3',
  './parishes-andong.js?v=V3',
  './parishes-masan.js?v=V3',
  './parishes-gwangju.js?v=V3',
  './parishes-jeonju.js?v=V3',
  './parishes-jeju.js?v=V3',
  './parishes-military.js?v=V3',
  './icon-192x192.png',
  './icon-512x512.png',
