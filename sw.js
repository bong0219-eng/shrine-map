/* 가톨릭길동무 Service Worker - V37-6-18
   캐시를 매번 삭제하지 않고, 버전 변경 시 오래된 캐시만 정리합니다.
   localStorage/사용자 설정은 건드리지 않습니다. */
const CACHE_VERSION = 'catholic-way-V37-6-18';
const APP_SHELL = [
  './',
  './index.html',
  './diocese.html',
  './qa-firebase.html',
  './parishes.js?v=V37-6-18',
  './style.css?v=V37-6-18',
  './app.js?v=V37-6-18',
  './web.js?v=V37-6-18',
  './prayer.js?v=V37-6-18',
  './patches.js?v=V37-6-18',
  './sw-update.js?v=V37-6-18',
  './manifest.json',
  './icon-192x192.png',
  './icon-512x512.png',
